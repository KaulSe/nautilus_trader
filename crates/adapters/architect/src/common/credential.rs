...
//! Architect API credential storage for bearer token authentication.

use core::fmt::Debug;

use zeroize::ZeroizeOnDrop;

/// API credentials required for Architect bearer token authentication.
///
/// Architect uses bearer token authentication where the API key and secret
